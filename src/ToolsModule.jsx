...
const TOOL_CATALOG = [
  ...
  { id: "growth-playbook", name: "推品计划", desc: "五阶段九步作战手册 · 按运营账号分开保存 · 可导出 PDF", icon: "🗺️", category: "运营", target: "inline", openUrl: "tools/growth-playbook/index.html" },
  { id: "growth-playbook-new", name: "推品计划 · 空白", desc: "新开一份空白计划，写下一支 ASIN，不影响已有计划", icon: "📝", category: "运营", target: "inline", openUrl: "tools/growth-playbook/index.html?new=1" },
];
